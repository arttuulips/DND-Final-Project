...
public Task<IEnumerable<BlogPost>> GetAsync(SearchBlogPostParametersDto searchParams)UserFileDao: Handles operations for the User data in a similar manner.
